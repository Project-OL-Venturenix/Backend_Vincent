...
public interface GroupScoreOperation {
  @PostMapping("/groupscores/addScore")
  ...
  @GetMapping("/grouptestcases/eventid/{eventid}")
  ResponseEntity<GroupScoreDTO> getGroupTestCaseByEventId(@PathVariable String eventid);
